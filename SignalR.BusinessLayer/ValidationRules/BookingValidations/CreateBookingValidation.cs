...
namespace SignalR.BusinessLayer.ValidationRules.BookingValidations
{
    public class CreateBookingValidation:AbstractValidator<CreateBookingDto>
    {
        public CreateBookingValidation()
        {
            ...
            RuleFor(x => x.Name).MaximumLength(500).WithMessage("Lütfen Açıklama Alanına En Fazla 500 Karakter Veri Girişi Yapınız!");

            RuleFor(x => x.Mail).EmailAddress().WithMessage("Lütfen Geçerli Bir Email Adres Giriniz!");
